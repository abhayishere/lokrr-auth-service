...
type ValidateTokenResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Authorized    string                 `protobuf:"bytes,1,opt,name=authorized,proto3" json:"authorized,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ValidateTokenResponse) GetAuthorized() string {
	if x != nil {
		return x.Authorized
	}
	return ""
...
var file_authService_auth_proto_rawDesc = string([]byte{
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x57, 0x0a, 0x0f,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x37, 0x0a, 0x15,
	...
	0x7a, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x61, 0x75, 0x74, 0x68, 0x6f,
	0x72, 0x69, 0x7a, 0x65, 0x64, 0x32, 0x92, 0x02, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65,
	...
	0x6e, 0x12, 0x67, 0x0a, 0x0d, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x54, 0x6f, 0x6b,
	...
	0x93, 0x02, 0x17, 0x3a, 0x01, 0x2a, 0x22, 0x12, 0x2f, 0x76, 0x31, 0x2f, 0x76, 0x61, 0x6c, 0x69,
	0x64, 0x61, 0x74, 0x65, 0x2d, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x42, 0x3b, 0x5a, 0x39, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x62, 0x68, 0x61, 0x79, 0x69, 0x73,
	0x68, 0x65, 0x72, 0x65, 0x2f, 0x6c, 0x6f, 0x6b, 0x72, 0x72, 0x2d, 0x61, 0x75, 0x74, 0x68, 0x2d,
...
var (
	...
	file_authService_auth_proto_rawDescData []byte
)

func file_authService_auth_proto_rawDescGZIP() []byte {
	file_authService_auth_proto_rawDescOnce.Do(func() {
		file_authService_auth_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_authService_auth_proto_rawDesc), len(file_authService_auth_proto_rawDesc)))
	})
...
func file_authService_auth_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_authService_auth_proto_rawDesc), len(file_authService_auth_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
